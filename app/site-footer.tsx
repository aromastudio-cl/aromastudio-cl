...
export default function SiteFooter() {
  return <footer className="site-footer">
    ...
    <nav aria-label="Productos"><strong>PRODUCTOS</strong><Link href="/tienda">Todos los productos</Link><Link href="/tienda">Home spray</Link><Link href="/tienda">Mikados varilla</Link><Link href="/tienda">Difusor para auto</Link></nav>
