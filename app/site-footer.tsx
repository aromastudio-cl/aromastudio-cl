...
export default function SiteFooter() {
  ...
  return <footer className="site-footer" id="contacto">
    ...
    <nav aria-label="Productos"><strong>PRODUCTOS</strong><Link href="/tienda">Tienda online</Link>{categories.map(category=><Link href={`/tienda?categoria=${encodeURIComponent(category.slug)}`} key={category.id}>{category.name}</Link>)}</nav>
