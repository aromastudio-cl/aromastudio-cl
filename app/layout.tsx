...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: "Aroma Studio | Perfumería de autor", description: "Descubre la esencia que habla de ti.", icons: { icon: { url: "/favicon-logo.png", type: "image/png", sizes: "128x128" } }, openGraph: { title: "Aroma Studio", description: "Descubre la esencia que habla de ti.", images: [{ url: image, width: 1792, height: 933 }] }, twitter: { card: "summary_large_image", images: [image] } };
}
