...
export default function SiteFooter() {
  ...
  return <footer className="site-footer" id="contacto">
    ...
    <nav aria-label="Productos"><strong>PRODUCTOS</strong><Link href="/tienda">Tienda online</Link></nav>
    <nav aria-label="Información"><strong>INFORMACIÓN</strong><Link href="/contacto">Contacto</Link></nav>
