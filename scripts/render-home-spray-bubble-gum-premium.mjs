...
const base = "art-direction/candidates/home-spray-bubble-gum-base.png";
const volume = process.argv[2] === "250" ? "250" : "120";
const outputPng = `art-direction/candidates/home-spray-bubble-gum-${volume}-premium.png`;
const outputWebp = `art-direction/candidates/home-spray-bubble-gum-${volume}-premium.webp`;
const width = 262;
const height = 476;
...
const typography = Buffer.from(`<svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="131" y="157" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" font-size="30" fill="#18130f" letter-spacing="0.7">BUBBLE GUM</text>
  <line x1="39" y1="177" x2="223" y2="177" stroke="#b58a51" stroke-width="0.8"/>
  <text x="131" y="196" text-anchor="middle" font-family="Arial, sans-serif" font-size="7.8" letter-spacing="1.8" fill="#30261f">LUXURY HOME FRAGRANCE</text>
  <text x="131" y="251" text-anchor="middle" font-family="Georgia, serif" font-size="11.2" fill="#211a15">
    <tspan x="131">NARANJA, MANDARINA, PLÁTANO,</tspan>
    <tspan x="131" dy="17">FRUTOS ROJOS, JAZMÍN, VIOLETAS,</tspan>
    <tspan x="131" dy="17">TUTTI FRUTTI Y ALGODÓN DE AZÚCAR.</tspan>
  </text>
